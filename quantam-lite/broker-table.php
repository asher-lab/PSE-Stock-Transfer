...
<body class="sidebar-mini fixed">
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <div class="card">
         <div class="card-header"><h5 class="card-header-text">Broker Information Table</h5> <p><code>select * from brokerinfo_tb ORDER BY transactionID</code></p></div>
         ...
         <table class="table">
                <thead>
                  ...
                  <th scope="col">Transaction ID</th>
                    ...
                    <th scope="col">Broker Contact No. </th>
                    <th scope="col">Your Account Name w/ Broker</th>
                ...
                <tbody>
                  <?php 
                    ...
                    global $con;
                    $query = "select * from brokerinfo_tb ORDER BY transactionID";
                    ...
                    while ($row = mysqli_fetch_array($result)){
                        ...
                        $Account_wBroker =  $row['Account_wBroker'];
                      ...
                      echo "<tr>
                        <td>$transactionID</td>
                        <td>$Brokerid</td>
                        <td>$Broker_contact</td>
                        <td>$Account_wBroker</td>
