...
<body class="sidebar-mini fixed">
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <div class="card">
         <div class="card-header"><h5 class="card-header-text">Stock Information Table</h5> <p><code>select * from stockinfo_tb ORDER BY transactionID</code></p></div>
         ...
         <table class="table">
                <thead>
                  ...
                  <th scope="col">Transaction ID</th>
                    ...
                    <th scope="col">Average Cost of Stock</th>
                    <th scope="col">No. of Stock Certificates</th>
                ...
                <tbody>
                  <?php 
                    ...
                    global $con;
                    $query = "select * from stockinfo_tb ORDER BY transactionID";
