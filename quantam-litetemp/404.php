...
<!-- Main-body start -->
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material">
                                                            ...
                                                            <div class="form-group form-danger form-static-label">
                                                                <input type="text" name="transferfee" class="form-control">
                                                                <span class="form-bar"></span>
						...
						<input type="submit" name="txsub" value="Submit" class="btn btn-xlg btn-primary waves-effect waves-light" onclick="return confirm('Are you sure?')">
