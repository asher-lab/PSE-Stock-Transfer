...
<body class="sidebar-mini fixed">
   ...
   <div class="wrapper">
      ...
      <div class="content-wrapper">
         ...
         <div class="card">
         <div class="card-header"><h5 class="card-header-text">Customer Information Table</h5> <p><code>select * from custinfo_tb ORDER BY transactionID</code></p></div>
         ...
         <table class="table">
                ...
                <tbody>
                  <?php 
                    ...
                    global $con;
                    $query = "select * from custinfo_tb ORDER BY transactionID";
